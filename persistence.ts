...
export const saveBrainState = async (state: BrainState) => {
    ...
    try {
        ...
        await setDoc(doc(db, COLLECTION_NAME, deviceId), JSON.parse(JSON.stringify(state)));
    } catch (e) {}
};
